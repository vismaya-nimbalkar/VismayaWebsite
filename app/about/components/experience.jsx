...
const experiences = [
	{
		...
		startDate: "Dec 2025",
		endDate: "Present",
		company: "After The Silence",
		position: "Social Work / Researcher",
		type: "Advocacy",
	...
	},
	{
		...
		startDate: "Jun 2025",
		endDate: "Jun 2025",
		company: "Law Chambers of Lakshmi Menon",
		position: "Legal Intern",
		type: "Internship",
		location: "India",
		description:
			"Drafted documents such as a General Power of Attorney (GPA), Writ Petitions, and Memos of Compliance. Undertook legal research work on a range of subjects, including Intellectual Property Laws, the Criminal Procedure Code, GST Regulations, Government Contract Law, and Arbitration. Assisted in administrative and clerical work.",
		skills: [
			"Legal Drafting",
			"IP Laws",
			"CrPC",
	...
	},
	{
		...
		startDate: "Apr 2024",
		endDate: "May 2024",
		company: "Association of Indian Principals",
		position: "Intern",
		type: "Internship",
		location: "India",
		description:
			"Worked extensively with spreadsheets, reports, and analysed problems and developed solutions. Prepared project presentations and reports to assist senior staff. Participated in workshops and presentations related to projects to gain knowledge.",
		skills: ["Data Analysis", "Project Coordination", "Administration & operations"],
	}
];

// Removed experiences.reverse() so your most recent role stays at the top!
